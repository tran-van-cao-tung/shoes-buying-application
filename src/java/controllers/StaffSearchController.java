...
public class StaffSearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String checkCurrent_Search = searchValue.trim();
            if (checkCurrent_Search.isEmpty() || checkCurrent_Search.equals(" ")) {
                request.setAttribute("SEARCH_ERROR", "No blankspace!");
                session.setAttribute("CURRENT_SEARCH", searchValue);
            ...
            if (checkAllCorrect == true) {
                ...
                shoesDAO.searchIdAndName(searchValue);
                // Get id or name out
